...
public class EventTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.v("EventTab:", ""+makeListItem().get(0));
    ...
    public ArrayList<ListItem> makeListItem(){
        ArrayList<String> mName = new ArrayList<String>(Arrays.asList("P1 Club","Die Puppenstars","Deutsches Theater"));
        ArrayList<String> mAddress =new ArrayList<String>(Arrays.asList("Straubingerstr. 3  München","Hauptstr. 3  München", "Auenstr. 2  München"));
        ArrayList<Integer> mRating= new ArrayList<Integer>(Arrays.asList(1,4,6));
        ArrayList<Integer> mImageRescourceId= new ArrayList<Integer>(Arrays.asList(R.drawable.p1_muenchen, R.drawable.die_puppenstars, R.drawable.deutsches_theater_saal));
